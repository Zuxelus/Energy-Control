...
public class ModMenu implements ModMenuApi {
	...
	public Screen create(Screen screen) {
		...
		general.addEntry(
				entryBuilder.startIntField(new TranslatableText("config." + EnergyControl.MODID + ".infoPanelRefreshPeriod"), ConfigHandler.infoPanelRefreshPeriod)
						.setDefaultValue(20).setTooltip(new LiteralText("infoPanelRefreshPeriod"))
