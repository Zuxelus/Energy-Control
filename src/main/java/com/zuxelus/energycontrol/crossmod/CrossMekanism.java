...
public class CrossMekanism extends CrossModBase {
	...
	public List<FluidInfo> getAllTanks(BlockEntity te) {
		...
		if (te instanceof TileEntityNutritionalLiquifier) {
			result.add(toFluidInfo(((TileEntityNutritionalLiquifier) te).fluidTank));
			return result;
		}
		if (te instanceof TileEntityAntiprotonicNucleosynthesizer) {
	...
	public CompoundTag getCardData(BlockEntity te) {
		if (te instanceof TileEntityEnergyCube) {
			CompoundTag tag = setStorage(((TileEntityEnergyCube) te).getEnergyContainer());
			return tag;
		}
		if (te instanceof TileEntityFactory) {
		...
		if (te instanceof TileEntityElectricMachine) {
			CompoundTag tag = setStorage(((TileEntityElectricMachine) te).getEnergyContainer());
			addUsage(tag, ((TileEntityElectricMachine) te).getEnergyContainer(), ((TileEntityElectricMachine) te).getActive());
			return tag;
		}
		if (te instanceof TileEntityAdvancedElectricMachine) {
			CompoundTag tag = setStorage(((TileEntityAdvancedElectricMachine) te).getEnergyContainer());
		...
		if (te instanceof TileEntityCombiner) {
			CompoundTag tag = setStorage(((TileEntityCombiner) te).getEnergyContainer());
		...
		if (te instanceof TileEntityMetallurgicInfuser) {
			CompoundTag tag = setStorage(((TileEntityMetallurgicInfuser) te).getEnergyContainer());
		...
		if (te instanceof TileEntityTeleporter) {
			CompoundTag tag = setStorage(((TileEntityTeleporter) te).getEnergyContainer());
			return tag;
		}
		if (te instanceof TileEntityElectricPump) {
			CompoundTag tag = setStorage(((TileEntityElectricPump) te).getEnergyContainer());
		...
		if (te instanceof TileEntityRotaryCondensentrator) {
			CompoundTag tag = setStorage(((TileEntityRotaryCondensentrator) te).getEnergyContainer());
		...
		if (te instanceof TileEntityChemicalOxidizer) {
			CompoundTag tag = setStorage(((TileEntityChemicalOxidizer) te).getEnergyContainer());
		...
		if (te instanceof TileEntityChemicalInfuser) {
			CompoundTag tag = setStorage(((TileEntityChemicalInfuser) te).getEnergyContainer());
		...
		if (te instanceof TileEntityElectrolyticSeparator) {
			CompoundTag tag = setStorage(((TileEntityElectrolyticSeparator) te).getEnergyContainer());
		...
		if (te instanceof TileEntityPrecisionSawmill) {
			CompoundTag tag = setStorage(((TileEntityPrecisionSawmill) te).getEnergyContainer());
			addUsage(tag, ((TileEntityPrecisionSawmill) te).getEnergyContainer(), ((TileEntityPrecisionSawmill) te).getActive());
			return tag;
		}
		if (te instanceof TileEntityChemicalDissolutionChamber) {
			CompoundTag tag = setStorage(((TileEntityChemicalDissolutionChamber) te).getEnergyContainer());
		...
		if (te instanceof TileEntityChemicalWasher) {
			CompoundTag tag = setStorage(((TileEntityChemicalWasher) te).getEnergyContainer());
		...
		if (te instanceof TileEntityChemicalCrystallizer) {
			CompoundTag tag = setStorage(((TileEntityChemicalCrystallizer) te).getEnergyContainer());
		...
		if (te instanceof TileEntitySeismicVibrator) {
			CompoundTag tag = setStorage(((TileEntitySeismicVibrator) te).getEnergyContainer());
			return tag;
		}
		if (te instanceof TileEntityPressurizedReactionChamber) {
			CompoundTag tag = setStorage(((TileEntityPressurizedReactionChamber) te).getEnergyContainer());
		...
		if (te instanceof TileEntityIsotopicCentrifuge) {
			CompoundTag tag = setStorage(((TileEntityIsotopicCentrifuge) te).getEnergyContainer());
		...
		if (te instanceof TileEntityNutritionalLiquifier) {
			CompoundTag tag = setStorage(((TileEntityNutritionalLiquifier) te).getEnergyContainer());
			addUsage(tag, ((TileEntityNutritionalLiquifier) te).getEnergyContainer(), ((TileEntityNutritionalLiquifier) te).getActive());
			addTank("tank", tag, ((TileEntityNutritionalLiquifier) te).fluidTank);
			return tag;
		}
		if (te instanceof TileEntityAntiprotonicNucleosynthesizer) {
			CompoundTag tag = setStorage(((TileEntityAntiprotonicNucleosynthesizer) te).getEnergyContainer());
		...
		if (te instanceof TileEntityResistiveHeater) {
			CompoundTag tag = setStorage(((TileEntityResistiveHeater) te).getEnergyContainer());
		...
		if (te instanceof TileEntityBasicLaser) {
			CompoundTag tag = setStorage(((TileEntityBasicLaser) te).getEnergyContainer());
			return tag;
		}
	...
	public static void addTank(String name, CompoundTag tag, IChemicalTank<?,?> tank) {
		if (tank.isEmpty())
			tag.putString(name, "N/A");
		else
			tag.putString(name, String.format("%s: %s mB", Language.getInstance().getOrDefault(tank.getType().getTranslationKey()), tank.getStored()));
	}

	public static void addTank(String name, CompoundTag tag, IExtendedFluidTank tank) {
		if (tank.isEmpty())
			tag.putString(name, "N/A");
		else
			tag.putString(name, String.format("%s: %s mB", Language.getInstance().getOrDefault(tank.getFluid().getTranslationKey()), tank.getFluidAmount()));
	}

	public static void addTank(String name, CompoundTag tag, MergedChemicalTank tank) { // MergedChemicalTank doesn't exist in 1.15
		Current current = tank.getCurrent();
		if (current == Current.EMPTY)
			tag.putString(name, "N/A");
		else
	...
	public static CompoundTag boilerTag(BoilerMultiblockData block) {
		if (block == null)
			return null;
		CompoundTag tag = new CompoundTag();
	...
	public static String getTempString(double temp) {
		return formatTemp(MekanismConfig.common.tempUnit.get(), temp);
	}
