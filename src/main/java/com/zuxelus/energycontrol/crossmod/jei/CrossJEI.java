...
public class CrossJEI implements IModPlugin {
	...
	public void registerRecipes(IRecipeRegistration registry) {
		registry.addRecipes(KitAssemblerRecipeType.TYPE.getRecipes(Minecraft.getInstance().world), KitAssemblerRecipeCategory.id);
	...
	private void registerItem(IRecipeRegistration registry, IItemProvider item, String name) {
		if (item != null)
			registry.addIngredientInfo(new ItemStack(item), VanillaTypes.ITEM, I18n.format(name));
	}
