...
public class KitAssemblerRecipeCategory implements IRecipeCategory<KitAssemblerRecipe> {
	...
	private static final String title = I18n.format(ModItems.kit_assembler.get().getTranslationKey());
	...
	@Override
	public void draw(KitAssemblerRecipe recipe, double mouseX, double mouseY) {
		animatedarrow.draw(57, 19);
	}
}
