...
public class GuiScreenColor extends GuiBase {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		func_146110_a(guiLeft + 20, guiTop + 34, isDarkPicker ? 80 : 0, 0, 80, 80, 160, 80);
	...
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) {
		...
		if (screenColor > -1) {
			...
			NetworkHelper.updateSeverTileEntity(panel.xCoord, panel.yCoord, panel.zCoord, 6, colorBack);
	...
	private void setColorText(Color c) {
		colorText = c.getRGB();
		NetworkHelper.updateSeverTileEntity(panel.xCoord, panel.yCoord, panel.zCoord, 7, colorText);
