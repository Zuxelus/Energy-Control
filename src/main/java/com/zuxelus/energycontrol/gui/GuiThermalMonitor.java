...
public class GuiThermalMonitor extends GuiBase {
	...
	public void init() {
		super.init();
		addButton(new CompactButton(0, guiLeft + 47, guiTop + 20, 22, 12, "-1", (button) -> { actionPerformed(button); }));
		addButton(new CompactButton(1, guiLeft + 47, guiTop + 31, 22, 12, "-10", (button) -> { actionPerformed(button); }));
		addButton(new CompactButton(2, guiLeft + 12, guiTop + 20, 36, 12, "-100", (button) -> { actionPerformed(button); }));
		addButton(new CompactButton(3, guiLeft + 12, guiTop + 31, 36, 12, "-1000", (button) -> { actionPerformed(button); }));
		addButton(new CompactButton(4, guiLeft + 12, guiTop + 42, 57, 12, "-10000", (button) -> { actionPerformed(button); }));

		addButton(new CompactButton(5, guiLeft + 122, guiTop + 20, 22, 12, "+1", (button) -> { actionPerformed(button); }));
		addButton(new CompactButton(6, guiLeft + 122, guiTop + 31, 22, 12, "+10", (button) -> { actionPerformed(button); }));
		addButton(new CompactButton(7, guiLeft + 143, guiTop + 20, 36, 12, "+100", (button) -> { actionPerformed(button); }));
		addButton(new CompactButton(8, guiLeft + 143, guiTop + 31, 36, 12, "+1000", (button) -> { actionPerformed(button); }));
		addButton(new CompactButton(9, guiLeft + 122, guiTop + 42, 57, 12, "+10000", (button) -> { actionPerformed(button); }));
