...
public final class ModContainerTypes {
	...
	public static final RegistryObject<MenuType<ContainerRemoteThermalMonitor>> remote_thermo = CONTAINER_TYPES.register("remote_thermo", () -> IForgeContainerType.create(ContainerRemoteThermalMonitor::new));
