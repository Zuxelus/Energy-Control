...
public class ModItems {
	...
	//public static final IRecipeSerializerRegistryObject<StorageArrayRecipe> ARRAY_SERIALIZER = RECIPE_SERIALIZERS.register("array", ArrayRecipeSerializer::new);
	//public static final IRecipeSerializerRegistryObject<KitAssemblerRecipe> KIT_ASSEMBLER_SERIALIZER = RECIPE_SERIALIZERS.register("kit_assembler", KitAssemblerSerializer::new);
}
