		...
		if (!world.isRemote) {
			...
			case SPREAD:
				...
				if (arrow.getIsCritical()) {
					...
					arrow2.setAim(player, player.rotationPitch + 2.0F, player.rotationYaw, 0.0F, f * 3.0F, 1.0F);
					...
					arrow3.setAim(player, player.rotationPitch - 2.0F, player.rotationYaw, 0.0F, f * 3.0F, 1.0F);
					...
					arrow4.setAim(player, player.rotationPitch, player.rotationYaw + 2.0F, 0.0F, f * 3.0F, 1.0F);
					...
					arrow5.setAim(player, player.rotationPitch, player.rotationYaw - 2.0F, 0.0F, f * 3.0F, 1.0F);
