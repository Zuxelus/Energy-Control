...
public class ItemCardEnergy extends ItemCardMain {
	...
	public List<PanelSetting> getSettingsList() {
		...
		result.add(new PanelSetting(I18n.format("msg.ec.cbInfoPanelEnergy"), 1, ItemCardType.CARD_ENERGY));
		result.add(new PanelSetting(I18n.format("msg.ec.cbInfoPanelFree"), 2, ItemCardType.CARD_ENERGY));
		result.add(new PanelSetting(I18n.format("msg.ec.cbInfoPanelCapacity"), 4, ItemCardType.CARD_ENERGY));
		result.add(new PanelSetting(I18n.format("msg.ec.cbInfoPanelPercentage"), 8, ItemCardType.CARD_ENERGY));
		return result;
	}
