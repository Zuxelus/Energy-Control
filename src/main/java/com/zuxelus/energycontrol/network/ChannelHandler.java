...
public class ChannelHandler {
	...
	public static void init() {
		...
		network.registerMessage(PacketEncounter.class, PacketEncounter.class, 4, Side.CLIENT);
		network.registerMessage(PacketAcounter.class, PacketAcounter.class, 5, Side.CLIENT);
