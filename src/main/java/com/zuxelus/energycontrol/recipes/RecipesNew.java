...
public class RecipesNew {
	...
	public static void addRecipes() {
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ItemHelper.blockMain, 1, BlockDamages.DAMAGE_INFO_PANEL_EXTENDER),
		...
		for (int i = 0; i <= ItemCardType.CARD_MAX; i++)
			if (ItemCardMain.containsCard(i))
				GameRegistry.addRecipe(new ShapelessOreRecipe(IC2Items.getItem("electronicCircuit"), new ItemStack(ItemHelper.itemCard, 1, i)));
	...
	private static void addExpRecipes() {
		...
		Recipes.advRecipes.addRecipe(new ItemStack(ItemHelper.blockMain, 1, BlockDamages.DAMAGE_AFSU), new Object[] {
			"MGM", "IAI", "MGM",
		...
		Recipes.advRecipes.addRecipe(new ItemStack(ItemHelper.blockSeedManager, 1, 0), new Object[] {
			" Z ", "#M#", "#C#",
		...
		Recipes.advRecipes.addRecipe(new ItemStack(ItemHelper.blockSeedManager, 1, 1), new Object[] {
			"GGG", "#C#", "#Z#",
				'Z', new ItemStack(ItemHelper.blockSeedManager),
				'C', "circuitAdvanced",
				'G', Blocks.glass,
				'#', Blocks.chest});
