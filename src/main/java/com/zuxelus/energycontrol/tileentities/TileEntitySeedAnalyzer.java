...
public class TileEntitySeedAnalyzer extends TileEntityInventory implements ITickable, ITilePacketHandler, ISlotItemFilter, IEnergySink {
	...
	private void updateActive() {
		...
		if (stack == null || stack.getItem() != CrossModLoader.getCrossMod(ModIDs.IC2).getItem("seed"))
			return;
	...
	public boolean canExtractItem(int slot, ItemStack stack, EnumFacing side) {
		...
		if (crop == null || crop.getItem() != CrossModLoader.getCrossMod(ModIDs.IC2).getItem("seed"))
			return false;
