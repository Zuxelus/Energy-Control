...
public class FluidInfo {
	...
	public void write(ICardReader reader) {
		if (translationKey != null)
			reader.setString("name", LanguageMap.getInstance().getOrDefault(translationKey));
		else
	...
	public void write(ICardReader reader, int i) {
		if (translationKey != null)
			reader.setString(String.format("_%dname", i), LanguageMap.getInstance().getOrDefault(translationKey));
		else
