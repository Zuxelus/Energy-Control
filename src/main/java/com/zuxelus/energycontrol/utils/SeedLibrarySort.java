...
public class SeedLibrarySort implements java.util.Comparator<ItemStack> {
	...
	public int compare(ItemStack seed_1, ItemStack seed_2) {
		...
		if (sort_type == GROWTH) {
			...
			value_1 = ItemCropSeed.getGrowthFromStack(seed_1) + ItemCropSeed.getGainFromStack(seed_1) + ItemCropSeed.getResistanceFromStack(seed_1);
			value_2 = ItemCropSeed.getGrowthFromStack(seed_2) + ItemCropSeed.getGainFromStack(seed_2) + ItemCropSeed.getResistanceFromStack(seed_2);
		}
